...
//        System.out.println("resolution | id = " +s1.getId() +" s1 = " + s1.toString());
//        System.out.println("resolution | id = " + s2.getId() + " s2 = " + s2.toString());
...
//        List<Predicate> predicates = cloneS.getPredicates();
//        //Sentence result;
...
////                        return cloneS;
////                    } else
//                    if (!unifier.isFailure() && !unifier.isEmpty()) {
//                        // P(x) v P(C) converts to P(C)
//                        System.out.println("factoring | Unification is found " + unifier.toString());
//                        cloneS.removePredicate(p2);
//                        cloneS = substitute(cloneS, unifier);
//                        //cloneS.sortPredicates();
//                        cloneS.setFailure(false);
//                        System.out.println("factoring | result: " + cloneS.toString());
//                        break;
//                        //return cloneS;
//                    }
//
